...
RUN microdnf install -y dnf && \
    ...
    dnf install -y librhsm-0.0.3-5.el8.x86_64 python3-subscription-manager-rhsm-1.28.42-1.el8.x86_64 subscription-manager-rhsm-certificates-20220623-1.el8.noarch && \
