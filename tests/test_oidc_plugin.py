...
class TestMatchingBackends(TestCase):
    ...
    def setUp(self):
        ...
        with open("./tests/backends/test-backends.yaml") as test_backends_file:
            test_config = {
                ...
                "IT_SERVICE_PORT": "80",
                "IT_SERVICE_PROTOCOL_SCHEME": "http",
                "PLUGIN_CHAIN": [
    ...
    def test_token_missing_client_id(self):
        ...
        with (
            ...
            # Ensure that the correct log message has been issued.
            self.assertTrue('The received token does not contain the "client_id" claim' in cm.output[0])
    ...
    def test_token_unauthorized_client_id(self):
        ...
        token = mock.Mock
        token.claims = {"client_id": "ca31f4cd-3613-11f0-8b6e-083a885cd988"}
        ...
        with (
            ...
            # Ensure that the correct log message has been issued.
            self.assertTrue(
                f'The client ID "{token.claims["client_id"]}" from the JWT is not present in the authorized service accounts for the back end'
                in cm.output[0]
            )
    ...
    def test_token_missing_scopes(self):
        ...
        token = mock.Mock
        token.claims = {"client_id": "721d25ca-3614-11f0-9fb6-083a885cd988"}
        ...
        with (
            ...
            # Ensure that the correct log message has been issued.
            self.assertTrue(
                f'The request is denied because the incoming token with client id "{token.claims["client_id"]}" does not contain any scopes'
                in cm.output[0]
            )
    ...
    def test_token_missing_some_scopes(self):
        ...
        token = mock.Mock
        token.claims = {"client_id": "721d25ca-3614-11f0-9fb6-083a885cd988", "scope": "scope_a"}
        ...
        with (
            ...
            # Ensure that the correct log message has been issued.
            self.assertTrue(
                f'The request is denied because the expected scope "scope_b" was not found in the incoming token\'s scopes "{[token.claims["scope"]]}" with client id "{token.claims["client_id"]}'
                in cm.output[0]
            )
    ...
    def test_token_missing_expiration_claim(self):
        ...
        token = mock.Mock
        token.claims = {
            "client_id": "721d25ca-3614-11f0-9fb6-083a885cd988",
        ...
        with (
            ...
            # Ensure that the correct log message has been issued.
            self.assertEqual(
                f'DEBUG:{self.app.name}:The claims for the token with client ID "{token.claims["client_id"]}" are invalid: missing_claim: Missing claim: "exp"',
                cm.output[0],
            )
    ...
    def test_token_invalid_expiration_claim(self):
        ...
        with (
            ...
            # Ensure that the correct log message has been issued.
            self.assertEqual(
                f'DEBUG:{self.app.name}:The claims for the token with client ID "{token.claims["client_id"]}" are invalid: expired_token: The token is expired',
                cm.output[0],
            )
    ...
    def test_token_missing_issuer_claim(self):
        ...
        with (
            ...
            # Ensure that the correct log message has been issued.
            self.assertEqual(
                f'DEBUG:{self.app.name}:The claims for the token with client ID "{token.claims["client_id"]}" are invalid: missing_claim: Missing claim: "iss"',
                cm.output[0],
            )
    ...
    def test_token_invalid_issuer_claim(self):
        ...
        with (
            ...
            # Ensure that the correct log message has been issued.
            self.assertEqual(
                f'DEBUG:{self.app.name}:The claims for the token with client ID "{token.claims["client_id"]}" are invalid: invalid_claim: Invalid claim: "iss"',
                cm.output[0],
            )
    ...
    def test_authorized_token_no_scopes_backend(self):
        ...
        tomorrow = datetime.today() + timedelta(days=1)
        token.claims = {
            "client_id": "349675ae-3625-11f0-a5d0-083a885cd988",
            "exp": tomorrow.timestamp(),
            "iss": self.oidc_jwt_plugin.issuer,
        ...
        with (
            ...
            if auth_data.get("client_id") != token.claims["client_id"]:
                self.fail('the context should contain the token\'s client ID inside the "auth_data" field')
