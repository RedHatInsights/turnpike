...
IT_SERVICE_HOST = os.environ.get("IT_SERVICE_HOST")
if not IT_SERVICE_HOST:
    raise ValueError("No IT_SERVICE_HOST set.")

IT_SERVICE_PORT = os.environ.get("IT_SERVICE_PORT")
if not IT_SERVICE_PORT:
    raise ValueError("No IT_SERVICE_PORT set.")

IT_SERVICE_PROTOCOL_SCHEME = os.environ.get("IT_SERVICE_PROTOCOL_SCHEME")
if not IT_SERVICE_PROTOCOL_SCHEME:
    raise ValueError("No IT_SERVICE_PROTOCOL_SCHEME set.")
